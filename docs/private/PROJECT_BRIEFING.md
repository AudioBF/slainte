...
| `EXPO_PUBLIC_USE_EDGE_MEAL_PLAN` | `"true"` = use `generate-meal-plan` Edge Function; unset/`"false"` = temporary client Gemini rollback path (**production: `true` as of 2026-06-23 — controlled canary ON**, see `MEAL_PLAN_EDGE_PRODUCTION_CANARY_V1.md`) |

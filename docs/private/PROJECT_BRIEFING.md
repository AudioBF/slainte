...
| `EXPO_PUBLIC_USE_EDGE_MEAL_PLAN` | `"true"` = use `generate-meal-plan` Edge Function; unset/`"false"` = temporary client Gemini rollback path (**production: `true` — controlled canary ON**, stabilization ⚠️ 2/3 spot-checks 2026-06-23; see `MEAL_PLAN_EDGE_PRODUCTION_STABILIZATION_V1.md`) |

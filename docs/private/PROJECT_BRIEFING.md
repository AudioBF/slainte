...
| `EXPO_PUBLIC_USE_EDGE_MEAL_PLAN` | `"true"` = Edge `generate-meal-plan`; `"false"` = client Gemini rollback (**production: `true` — canary ON**, rollout decision ⚠️ 2026-06-23; meal plan 5/5 spaced OK; ver `MEAL_PLAN_EDGE_PRODUCTION_ROLLOUT_DECISION_V1.md`) |
